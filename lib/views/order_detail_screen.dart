    ...
    for (int i = 0; i < widget.orderData.orderItems.length; i++) {
      setState(() {
        item_total = item_total +
            int.parse(widget.orderData.orderItems[i].quantity) *
                int.parse(widget.orderData.orderItems[i].price);
        tax = tax + int.parse(widget.orderData.orderItems[i].tax);
        net_payable = item_total +
            tax -
            int.parse(widget.orderData.discount) +
              ...
              children: <Widget>[
                ...
                ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      int price =
                          int.parse(widget.orderData.orderItems[index].price) *
                              int.parse(
                                  widget.orderData.orderItems[index].quantity);
                      return Padding(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Container(
                                  child: Text(
                                      "${widget.orderData.orderItems[index].itemName}",
                                      style: TextStyle(
                                          fontSize: 12,
                                ...
                                Text(
                                    "X ${widget.orderData.orderItems[index].quantity}",
                                    style: TextStyle(
                                        fontSize: 12,
                                        color: notification_title_color)),
                                Padding(
                ...
                Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      /* billUI("Taxes","Rs ${tax}"),*/
                      billUI("Delivery charge",
                          "Rs ${widget.orderData.deliveryCharge}"),
                      SizedBox(
                        height: 20,
                      ),
                      CommonMethods.horizontalLine(context),
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        widget.orderData.addressName == null
                            ? Text(
                                "Picked up from",
                                style: TextStyle(
                                    fontSize: 15,
                            ...
                            : Text(
                                "Delivered to ${widget.orderData.addressName == null ? "" : widget.orderData.addressName.toUpperCase()}",
                                style: TextStyle(
                                    fontSize: 15,
                                    fontWeight: FontWeight.bold,
                                    color: notification_title_color),
                        ...
                        widget.orderData.addressName == null
                            ? Text(
                                "${widget.orderData.restname.toUpperCase()}",
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          widget.orderData.isOnlinePaid == "0"
                              ? "Cash on delivery"
                              : "Online",
                          style: TextStyle(
                              fontSize: 12, color: notification_title_color),
                        ),
                      ],
                    ),
                  ),
